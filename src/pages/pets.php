...
<body>
    ...
    <section class="catalog">
        <div class="container">
            <form action="../config/livesearch.php" method="post" class="catalog__form">
                <input type="text" id="live_search" name="live_search" placeholder="Введите имя питомца" class="catalog__search title-fz16">
            </form>
    ...
    <div class="overlay-add">
        <div class="overlay__contact active">
            ...
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                <input type="text" placeholder="Введите имя питомца" name="pet-name" id="pet-name" class="overlay__input title-fz16" required>
                
                <textarea placeholder="Введите краткое описание" name="descr" id="descr" class="overlay__input title-fz16" required></textarea>
                
                <textarea placeholder="Введите историю" name="story" id="story" class="overlay__input title-fz16" required></textarea>
                
                <input class="overlay__input title-fz16 overlay__input-small" type="date" name="age" id="age" required>
                ...
                <input class="overlay__btn btn" type="submit" name="add" value="Добавить запись">
            </form>
        </div>
    </div>
