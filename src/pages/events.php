            ...
            <ul class="events__list">
                ...
                <li class="events__item">
                    <a href="events-page.php?event_id=<?=$row['id']?>" class="events__link">
                        <img src="../images/events/<?=$row['image']?>" alt="Арт-сеанс «Своими лапками»" class="events__img">
    ...
    <div class="overlay-add">
        <div class="overlay__contact active">
            ...
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                <input type="text" placeholder="Введите название" name="event-name" id="event-name" class="overlay__input title-fz16" required>
                
                <input type="text" placeholder="Введите место" name="place" id="place" class="overlay__input title-fz16"></input>
                ...
                <input class="overlay__input title-fz16 overlay__input-small" type="date" name="date" id="date"  required>
