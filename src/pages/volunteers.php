            ...
            <ul class="volonteer__list">
                <?php while($row = $resultVolonteer->fetch_assoc()):?>
                    <li class="volonteer__item">
                        <img src="../images/volonteer/<?=$row['image']?>" alt="Волонтёр" class="volonteer__img">
    ...
    <div class="overlay-add">
        <div class="overlay__contact active">
            ...
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                <input type="text" placeholder="Введите имя" name="volonteer-name" id="volonteer-name" class="overlay__input title-fz16" required>
                
                <textarea placeholder="Введите краткое описание" name="about" id="about" class="overlay__input title-fz16" required></textarea>

                


                <select class="overlay__input overlay__input-small" name="user" id="user">
                    <?php
                ...
                <select class="overlay__input overlay__input-small overlay__input-margin" name="petName" id="petName">
                    <?php
