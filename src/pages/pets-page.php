...
<body>
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="breadcrumbs__list">
                ...
                <a href="pets-page.php?pet_id=<?=$pet_id?>" class="breadcrumbs__link title-fz16"><?=$name?></a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="pets-info__info">
                <img src="../images/pets/<?php
                        ...
                        ?>/<?=$avatar?>" alt="<?=$name?>" class="pets-info__img">
                <div class="pets-info__wrapper">
                    <h3 class="pets-info__title title-fz24"><?=$name?></h3>
                    <p class="pets-info__descr">Пол:
                        <?php
                            if($gender == 'ж') {
                                echo 'девочка';
                            } else {
                    ...
                    <p class="pets-info__descr">Возраст: 
                        <?php
                            if(($age/12) >= 1 ) {
                                if(($age/12) == 1) {
                    ...
                    <p class="pets-info__descr"><?=$descr?></p>
            ...
            <ul class="gallery__list">
                ...
                <li class="gallery__item">
                    <img src="../images/pets/<?php
                        ...
                        ?>/<?=$row['img']?>" alt="" class="gallery__img">
                </li>
                <?php endwhile;?>
            </ul>
        </div>
    ...
    <div class="overlay-add">
        <div class="overlay__contact active">
            ...
            <h4 class="overlay__title title-fz20">Добавление фото</h4>
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                <input class="overlay__input" class="overlay__choose" id="picture" name="picture" type="file">
    ...
    <div class="overlay-change">
        <div class="overlay__contact active">
            ...
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                <input type="text" placeholder="Введите имя питомца" value="<?=$name?>" name="pet-name" id="pet-name" class="overlay__input title-fz16" required>
                
                <textarea placeholder="Введите краткое описание" value="<?=$descr?>" name="descr" id="descr" class="overlay__input title-fz16" required></textarea>
                
                <textarea placeholder="Введите историю" value="<?=$story?>" name="story" id="story" class="overlay__input title-fz16" required></textarea>
                
                <input class="overlay__input title-fz16 overlay__input-small"  value="<?=$date?>"  type="date" name="age" id="age" required>
                
                <select class="overlay__input overlay__input-small overlay__input-margin" name="type" id="type">
                    <option>собака</option>
                    <option>кот</option>
                </select>
               
                <select class="overlay__input overlay__input-small" name="gender" id="gender">
                    <option>м</option>
                    <option>ж</option>
                </select>
                
                <input class="overlay__input overlay__input-small overlay__input-margin" class="overlay__choose" id="picture" name="picture" type="file" required>
                
                
                <input class="overlay__btn btn" type="submit" name="change" value="Добавить запись">
            </form>
        </div>
    </div>
