        ...
        <div class="container">
            <div class="pets-info__info">
                ...
                <div class="pets-info__wrapper">
                    ...
                    <p class="pets-info__descr"><?=$story?></p>
    ...
    <div class="overlay-change">
        <div class="overlay__contact active">
            ...
            <form method="POST" class="overlay__form" enctype='multipart/form-data'>
                ...
                <textarea placeholder="Введите краткое описание" name="descr" id="descr" class="overlay__input title-fz16" required><?=$descr?></textarea>
                
                <textarea placeholder="Введите историю" name="story" id="story" class="overlay__input title-fz16" required><?=$story?></textarea>
                ...
                <input class="overlay__input overlay__input-small overlay__input-margin" class="overlay__choose" id="picture" name="picture" value="../images/pets/<?php
                            switch ($type) {
                                case 'собака':
                                    echo 'dogs';
                                    break;
