...
<head>
    ...
    <title>Stray Safe - подари жизнь</title>
        ...
        <div class="container">
            ...
            <div class="ourpets__wrapper">
                <button class="ourpets__arrow ourpets__arrow-left">
                    <img src="images/ourpets/paw-left.svg" alt="Стрелка слайдера влево" class="ourpets__paw-outline">
                    <img src="images/ourpets/paw-left-fill.svg" alt="Стрелка слайдера влево" class="ourpets__paw-fill">
                </button>
                <button class="ourpets__arrow ourpets__arrow-right">
                    <img src="images/ourpets/paw-right.svg" alt="Стрелка слайдера вправо" class="ourpets__paw-outline">
                    <img src="images/ourpets/paw-right-fill.svg" alt="Стрелка слайдера вправо" class="ourpets__paw-fill">
                </button>
            </div>
